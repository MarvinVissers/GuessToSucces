<?php
    ...
    */
    ...
    require('../functions/model/constructorstandings.php');
    ...
    $constructorStandings = $standingsCtrl->getConstructorStandings();
    ...
    <body>
        <main class="content" id="content">
            ...
            <article class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <h1 class="container__title">Current constructor championship standings</h1>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-hover">
                            <thead>
                                <tr> <td>Position</td> <td>Name</td> <td>Nationality</td> <td>Points</td> <td>More info</td> </tr>
                            </thead>

                            <tbody>
                                <?php
                                    // Looping through the current constructor stanings
                                    foreach ($constructorStandings as $constructor) {
                                        ?>
                                            <tr>
                                                <td><?php echo $constructor->getPositionText(); ?></td>
                                                <td><?php echo $constructor->getConstructor()->getName(); ?></td>
                                                <td><?php echo $constructor->getConstructor()->getNationality(); ?></td>
                                                <td><?php echo $constructor->getPoints(); ?></td>
                                                <td><a href="<?php echo $constructor->getConstructor()->getUrl(); ?>" class="table--link" target="_blank" rel="noopener noreferrer">Wikipedia</a></td>
                                            </tr>
                                        <?php
                                    }
                                ?>
        ...
        <script>
            ...
            addActieveNavbar("constructor-overview");
        </script>
    </body>
</html>